    ...
    return (
        <div className="min-h-screen bg-white relative">
            ...
            <div className="bg-white p-[1rem] lg:p-[2rem] pb-[8rem]">
                ...
                {cartState.length > 0 ? <div className="p-[0.5rem] lg:p-[1.5rem] mt-[1.5rem] lg:pb-[10rem] lg:pt-[3rem]">
                    ...
                    <table className="w-full mt-[1rem]">
                        <thead className="w-full">
                            <tr className="grid grid-cols-4 text-left text-[0.9rem] lg:text-[1rem] text-gray-400">
                                <th className="lg:col-span-2">Product</th>
                                <th className="col-span-2 lg:col-span-1 text-center lg:text-left">Count</th>
                                <th>Total Cost</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div className="flex flex-col gap-[1rem justify-center items-center py-[8rem] pb-[10rem]">
